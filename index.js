...
+ 'TEL;type=CELL;type=VOICE;waid=553185642195:+55 31 98564-2195\n' // Nomor bot
...
Modelo ${prefix}verify untuk para começar a usar bot.`
  ...
  only: {
    ...
    ownerB: '*☒* Este recurso é para *TOBIRAMA*',
...
//--Info bot
  ...
  ‣ *Proprietário* : ⁖℘༒𝕿𝖔𝖇𝖎𝖗𝖆𝖒𝖆 𝕾𝖊𝖓𝖏𝖚—͟͟͞͞𖣘
...
//--Hilih maker
				...
				if (!isRegister) return reply(mess.only.daftarB)
					...
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						...
						exec(`webpmux -set exif ${addMetadata('TOM, 'SENJU (BOT)')} ${rano} -o ${rano}`, async (error) => {
            ...
            case 'antistiker':
                    ...
                    if (args[0] == 'on') {
                        ...
                        if(cek){
                            ...
                            aruga.reply(from, '*[Anti Sticker SPAM]* foi ativado\nCada membro do grupo cujo adesivo de spam for maior que 7 serão banidos pelo bot!', id)
                        }
                    } else if (args[0] == 'off') {
